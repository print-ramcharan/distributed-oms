package com.oms.fulfillmentservice.config;
...
public class KafkaConfig {
    ...
    @Bean
    public ConcurrentKafkaListenerContainerFactory<String, InventoryReservedEvent> fulfillmentKafkaListenerContainerFactory() {
