...
//        } catch (Exception ex) {
//            sendToDlq(event, ex);
//            throw new RuntimeException("OrderCreatedEvent publish failed", ex);
//        }
//    }
//
//    private void sendToDlq(OrderCreatedEvent event, Exception ex) {
//        DlqEnvelope envelope = new DlqEnvelope(
//                "order-service",
//                TOPIC,
//                event.getClass().getSimpleName(),
...
//        );
//
//        kafkaTemplate.send(DLQ_TOPIC, event.getOrderId().toString(), envelope);
//    }
//}
